...
datadir = '/Users/minghao/Research/Projects/JWST/ID4713_add/MASQUERADE_LAE/lya_stats/'
...
def mags_from_UV_param_simple_for_Lya(params, redshift, filtercurve):
    ...
    # A: the intensity at restframe 1215.67 AA
    # beta: the UV slope
    A, beta = params
...
def get_Muv_from_mag(mags, magerrs, redshift, cosmo):
    ...
    return -2.5*np.log10(Fnu/(1e-23*3631)), (beta, betaerr)
...
#        self.lya_result = result
    ...
    def get_line_properties(self):
        ...
        self.beta_quantile = np.percentile(self.beta_sample, [0.135,2.5,16,50,84,97.5,99.865])
